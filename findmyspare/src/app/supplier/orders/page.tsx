...
const GROUPS: Record<string, OrderStatus[]> = {
  ...
  Done: ["delivered", "completed", "cancelled", "disputed"],
};
const FILTERS = ["All", "New", "To ship", "Shipped", "Done"] as const;
...
export default function SupplierOrdersPage() {
  ...
  return (
    <div className="flex-1 flex flex-col">
      <TopBar title="Orders" backHref="/supplier" />
      <div className="px-5 pb-8 space-y-4">
        ...
        {loading ? (
          ...
          <Card className="text-center !p-8">
            ...
            <div className="text-[12px] text-ink-3">Incoming orders from buyers will appear here.</div>
          </Card>
        ) : (
